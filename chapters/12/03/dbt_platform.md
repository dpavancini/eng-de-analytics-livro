(dbt_platform)=
# Capítulo 12.3 - Finalizando a configuração do ambiente no dbt Cloud

Chegou a hora de conectar tudo o que você preparou nas seções anteriores. Aqui você criará o projeto no dbt Cloud, apontará para o Databricks e ligará o repositório do GitHub com o fork da Northwind.

1. **Acesse o dbt Cloud e abra o assistente**  
   - Entre em [cloud.getdbt.com](https://cloud.getdbt.com).  
...
2. **Escolha a plataforma de dados**  
   ...
   - O dbt Cloud carregará o formulário de conexão específico para o **Databricks**.
...
3. **Preencha as credenciais do Databricks**  
   ...
   - Clique em **Test Connection** e confirme que o dbt Cloud consegue acessar o Databricks.

4. **Conecte o repositório GitHub**  
   - Em “Select a repository”, escolha **GitHub**.  
   - Autorize o dbt Cloud a acessar sua conta seguindo o fluxo OAuth.  
...
5. **Finalize e execute um teste rápido**  
   - Revise o resumo exibido pelo dbt Cloud e clique em **Create Project**. A mensagem “Your project is ready!” confirma que tudo foi conectado.  
   - Abra o **dbt Cloud IDE (Studio)** no menu lateral.  
...
Ao concluir esta seção você terá o ambiente Databricks + GitHub + dbt pronto para desenvolver os modelos apresentados no Capítulo 15.
