...
3. **Gere os Access Tokens para o dbt**  
   ...
   - Em **Access Tokens**, selecione **Manage** e crie dois tokens: `dbt-developer` e `dbt-production`.  
   - Copie cada token e guarde em um local seguro; eles não serão exibidos novamente. Caso perca, basta gerar um novo.
