...
Há milhares de fontes de dados possíveis, desde bancos de dados relacionais com uma estrutura bem definida até textos escaneados, imagens, áudios, etc. Cada fonte de dados possui seu próprio formato de armazenamento dos dados e metadados, isto é, informações adicionais que facilitam a leitura e o processamento dos dados armazenados por essa fonte. 

Algumas fontes de dados, como bancos de dados relacionais, por exemplo, utilizam schemas e índices para garantir que os dados ali inseridos sigam algumas regras predefinidas e acelerem o desempenho das consultas a esses dados. Outras fontes de dados são menos rígidas quanto ao formato dos dados armazenados e podem ser chamadas de schemaless (do inglês, sem esquema). Essas fontes também podem utilizar índices para acelerar as consultas.
