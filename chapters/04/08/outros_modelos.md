...
O modelo lógico acrescenta a estrutura dos elementos ao modelo conceitual, tipos dos atributos, etc. Também é feita uma normalização dos dados, geralmente a chamada 3ª Forma Normal (3NF) de modo a criar um modelo de dados consistente e sem redundância.
